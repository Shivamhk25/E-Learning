...
const EnquireForm = ({
  ...
  const [areaofinterestValue, setAreaofinterestValue] = useState('')
  ...
  useEffect(() => {
    ...
    if (window) {
      ...
      setAreaofinterestValue(localStorage.getItem('areaofinterest') || '')

      if (courseName) {
        setAreaofinterestValue(courseName)
      }
  ...
  return (
    <>
      ...
      <>
        ...
        >
          <form onSubmit={submitHandler} className={styles2.form}>
            <div className="top_closing_button">
              <h3 className={styles.formHeader}>Have questions? Contact us</h3>
              {/* <div
                role="button"
            ...
            <div className="mobile_number_input">
              ...
              <div className="enquire_box_space" style={{ width: '100%' }}>
                <div className="form-inpt-contnr">
                  <input
                    type="tel"
                    value={contact}
                    className="form-inpt enquireFormInput2 embadedFormInputw"
