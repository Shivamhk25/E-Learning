...
const EnquireForm = ({
  ...
  downloadBrochure,
  brochureUrl,
  courseName = courseName || '', //eg. IIM EPCBIM or CIBOP etc
  propsdata,
}) => {
  ...
  //override locations only if - a specific override is present in the JSON schema
  if (
    courseName &&
    program_obj &&
        ...
        <div className="industry-project-popup-ctnr">
          ...
          <div className="enquire_form_main">
            <form onSubmit={submitHandler}>
              ...
              <div
                className="form-inpt-contnr enquire_box_space"
                style={{ display: 'none' }}
              >
                <select
                  value={locationValue}
