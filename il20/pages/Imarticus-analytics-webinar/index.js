...
import { GetWebinarByName } from '../../services/helper'
...
const Webinar_Analytics_Page = (props) => {
  console.log(props.propsdata.allData, 'res')
  const [load, setLoad] = useState(false)

  const [formModal, setFormModal] = useState(false)
  const [data, setData] = useState()

  const PROGRAM = 'Analytics Webinar'
...
export default Webinar_Analytics_Page
