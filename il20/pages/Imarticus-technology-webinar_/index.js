...
const Webinar_Technology_Page = (props) => {
  // console.log(props.webinardata.data.Header, 'data')
  ...
  const PROGRAM = 'Technology Webinar'
...
export default Webinar_Technology_Page
