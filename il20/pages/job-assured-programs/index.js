  ...
  return (
    <div style={{ fontFamily: 'Source Sans Pro' }}>
      <Layout toggleModal={toggleModal} propsdata={props.propsdata.allData}>
        <Head>
          <title>Job Assured Programs | Imarticus Learning</title>
          <meta
            name="description"
            content="Achieve your goals with our job assured programs. We’re known to produce qualified professionals and our purpose-driven programs are designed to help you land your dream job."
          />
          <meta
            name="keywords"
          ...
          <link
            rel="canonical"
            href="https://imarticus.org/job-assured-programs/"
          />
          <link
            rel="icon"
        ...
        {formModal && (
          <Modal toggleModal={toggleModal}>
            <EnquireForm
              ...
              propsid="Job Assured Program"
            />
          </Modal>
        )}
        {/* header */}
        <div
          className="image-container-jobassurance"
          style={{ width: '100%', boxSizing: 'border-box' }}
        >
          <div style={{ maxWidth: '1300px', marginTop: '-20px' }}>
            <div className="middle-text">
              <h1>JOb Assured Programs</h1>
              <p style={{ marginTop: '-10px' }}>
                We’re known to produce qualified professionals and our
                purpose-driven programs are designed to help you land your dream
                job.
              </p>
            </div>
            <div className="header_icon_data" style={{ marginTop: '32px' }}>
            ...
            <div
              ...
              className="jobassuredheaderbutton"
            >
              <button
                className="btn2"
                onClick={toggleModal}
            ...
            <div className="ideal_candidate_header">
              <div>
                <h1 className="ideal_title">
                  Achieve Your Goals With Our Job Assured Programs{' '}
                </h1>
              </div>
              <div className="master_webcard">
                {Program.mastering_arrjob.map(function (master, index) {
                  return (
                ...
                <div className="cards">
                  <div className="course-row">
                    {props.propsdata.allData &&
                      ...
                      props.propsdata.allData
                        .filter(
                          (course) => course.program == 'Job Assured Program'
                        )
                        .map((course) => (
                          <div
                            className={
                      ...
                      >
                        {props.propsdata.allData &&
                          ...
                          GetProgramsAsPerTagName(
                            ...
                            .filter(
                              (course) =>
                                course.program == 'Job Assured Program'
                            )
                            .map((course) => (
