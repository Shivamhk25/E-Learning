...
export default function Home(props) {
  const [selectedIndex, setSelectedIndex] = useState('INVESTMENT BANKING')
  ...
  // const output = document.querySelector('#image_finance')
  // const display_image = (s) => (output.innerText = s)
  ...
  return (
    <div style={{ fontFamily: 'Source Sans Pro' }}>
      <Layout toggleModal={toggleModal} propsdata={props.propsdata.allData}>
        <Head>
          <title>
            Finance Online Courses & Certifications | Imarticus Learning
          </title>
          <meta
            name="description"
            content="Imarticus Learning’s finance programs are for those who seek rewarding careers in investment banking, financial planning services, regulatory compliance, fintech and risk management."
          />
          <meta
            name="keywords"
          ...
          <link rel="canonical" href="https://imarticus.org/finance/" />
          <link
            rel="icon"
        ...
        {/* header */}
        <div
          className="image-container-finance"
        ...
        >
          <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
            ...
            <div className="finance_header_middle">
              <p>
                Imarticus Learning’s finance programs are for those who seek
                rewarding careers in investment banking, financial planning
                services, regulatory compliance, fintech and risk management and
                will teach you the intricacies of financial structures.
              </p>
            </div>
                ...
                <ul className="select">
                  <div id="ampSelector" layout="container">
                    <li
                      role="button"
                      option={0}
                      onClick={() => setSelectedIndex('INVESTMENT BANKING')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'INVESTMENT BANKING' && 'selected'
                      }`}
                    >
                      <span role="button">Investment banking</span>
                      <svg
                    ...
                    <li
                      role="button"
                      option={1}
                      onClick={() => setSelectedIndex('CAPITAL MARKET')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'CAPITAL MARKET' && 'selected'
                      }`}
                    >
                      <span role="button">capital market</span>
                      <svg
                        style={{ marginLeft: 'auto' }}
                        xmlns="http://www.w3.org/2000/svg"
                        alt="Analytics"
                    ...
                    <li
                      role="button"
                      option={2}
                      onClick={() => setSelectedIndex('CREDIT RISK')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'CREDIT RISK' && 'selected'
                      }`}
                    >
                      <span role="button">CREDIT RISK Management</span>
                      <svg
                        style={{ marginLeft: 'auto' }}
                        xmlns="http://www.w3.org/2000/svg"
                        alt="Technology"
              ...
              <div className="mobiletab-ourprogram">
                <Accordion defaultActiveKey="1" className="dropdownourprogram">
                  ...
                  <Accordion.Item eventKey="2" className="ourProgramaccordion">
                    <Accordion.Header>
                      <p className="navbar-drop-down-text">CAPITAL MARKET</p>
                    </Accordion.Header>
                    <Accordion.Body className="ourprogramaccans">
                      <Swiper
                        spaceBetween={26}
          ...
          <div className="joinimarticus_main">
            <div className="joinimarticusdiv">
              <div className="join_imarticus_img">
                ...
                <h3 className="join_title2">Imarticus?</h3>
                <img
              ...
              <div className="testimonal-carousals">
                ...
                >
                  {Program.studentReviews
                    .filter(
                      (review) => review.org == 'FAP' || review.org == 'CIBOP'
                    )
        ...
        {/* Blog */}
        <Blogimarticus category="finance" />
        ...
        <div className="news news_main" style={{}}>
          ...
          >
            <div className="award-main3">
              <h4 className="award_title2">Press Coverage</h4>
              <Swiper
                spaceBetween={26}
                style={{ paddingBottom: '10px', marginLeft: '4px' }}
                modules={[Pagination]}
