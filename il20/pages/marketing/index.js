...
export default function Home(props) {
  const [selectedIndex, setSelectedIndex] = useState('DIGITAL MARKETING')
  ...
  return (
    <div style={{ fontFamily: 'Source Sans Pro' }}>
      <Layout toggleModal={toggleModal} propsdata={props.propsdata.allData}>
        <Head>
          <title>Digital Marketing Courses | Imarticus Learning</title>
          <meta
            name="description"
            content="Our marketing programs will prepare you for a fulfilling career by focusing on educating you with industry best practices, the latest market trends and in-depth knowledge of the marketing industry."
          />
          <meta
            name="keywords"
          ...
          <link rel="canonical" href="https://imarticus.org/marketing/" />
          <link
            rel="icon"
        ...
        >
          <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
            ...
            <div className="finance_header_middle">
              <p>
                Imarticus Learning’s marketing programs will prepare you for a
                fulfilling career by focusing on educating you with industry
                best practices, the latest market trends and in-depth knowledge
                ...
                <ul className="select">
                  <div id="ampSelector" layout="container">
                    <li
                      role="button"
                      option={0}
                      onClick={() => setSelectedIndex('DIGITAL MARKETING')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'DIGITAL MARKETING' && 'selected'
                      }`}
                    >
              ...
              <div className="mobiletab-ourprogram">
                <Accordion defaultActiveKey="1" className="dropdownourprogram">
                  <Accordion.Item eventKey="1" className="ourProgramaccordion">
                    <Accordion.Header>
                      <p className="navbar-drop-down-text">DIGITAL MARKETING</p>
                    </Accordion.Header>
              ...
              <div className="speak_text1">
                {count ? (
                  <Typist loop onTypingDone={() => setCount(0)}>
                    ...
                    <span>affilate marketing manager</span>
        ...
        {/* <section className="seakadvisor">
          <div className="speackmaindiv">
            <div className="speakmain5" onClick={toggleModal}></div>
          </div>
        </section>
 */}
        {/* why join imarticus */}
                ...
                <div className="placement_text">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <img
                        src="https://cdn.pegasus.imarticus.org/imarticus_2/download2.svg"
                        width={24}
                        height={24}
                      ></img>
                    </button>
        ...
        {/* Blog */}
        <Blogimarticus category="marketing" />
