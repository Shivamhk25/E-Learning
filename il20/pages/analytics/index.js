...
export default function Home(props) {
  const [selectedIndex, setSelectedIndex] = useState('DATA SCIENCE')

  const [formModal, setFormModal] = useState(false)
  const [downloadBrochure, setDownloadBrochure] = useState(false)
  const [brochureUrl, setBrochureUrl] = useState()
  const [analytic_data, setAnalytic_data] = useState()
  ...
  return (
    <div style={{ fontFamily: 'Source Sans Pro' }}>
      <Layout toggleModal={toggleModal} propsdata={props.propsdata.allData}>
        <Head>
          <title>
            Analytics Online Courses, Training & Certification | Imarticus
            Learning
          </title>
          <meta
            name="description"
            content="Our analytics courses offer you the opportunity to learn and explore data science tools, understand machine learning, data-mining and prediction to improve business performance. Enrol Now!"
          />
          <meta
            name="keywords"
          ...
          <link rel="canonical" href="https://imarticus.org/analytics/" />
          <link
            rel="icon"
        ...
        {/* header */}
        <div
          className="image-container-analytics"
        ...
        >
          <div style={{ maxWidth: '1300px', margin: '0 auto' }}>
            ...
            <div className="finance_header_middle">
              <p>
                Imarticus Learning’s analytics courses offer you the opportunity
                to learn and explore data science tools, understand machine
                learning, data-mining and prediction to improve business
                performance.
              </p>
            </div>
        ...
        <Carrertransformationnext
          setdata
          heading="An In-Depth Look At The Data Science Job Landscape"
          cta_name="Download Analytics Career Report"
          onClick={() =>
            toggleModal({
              download: true,
              url: 'https://cdn.pegasus.imarticus.org/reports/analytics-data-science-jobs-in-india-2022.pdf',
            })
          }
        />
        {/* analytic program */}
        <section className="ourprogramspacing" style={{ background: '' }}>
          ...
          >
            <div id="courses" style={{ boxSizing: 'border-box' }}>
              <h2 className="course-detail-titles2 sec-heading">
                Our Analytics Programs
              </h2>
                ...
                <ul className="select">
                  <div id="ampSelector" layout="container">
                    <li
                      role="button"
                      option={0}
                      onClick={() => setSelectedIndex('DATA SCIENCE')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'DATA SCIENCE' && 'selected'
                      }`}
                    >
                      <span role="button">Data Science</span>
                      <svg
                    ...
                    <li
                      role="button"
                      option={2}
                      onClick={() => setSelectedIndex('SUPPLY CHAIN')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'SUPPLY CHAIN' && 'selected'
                      }`}
                    >
                      <span role="button">Supply Chain </span>
                      <svg
                        style={{ marginLeft: 'auto' }}
                        xmlns="http://www.w3.org/2000/svg"
                        alt="Technology"
                    ...
                    <li
                      role="button"
                      option={3}
                      onClick={() => setSelectedIndex('AI & ML')}
                      className={`course-detail-info-title center-all-768 button ${
                        selectedIndex == 'AI & ML' && 'selected'
                      }`}
                    >
                      <span role="button">AI & ML</span>
                      <svg
                        style={{ marginLeft: 'auto' }}
                        xmlns="http://www.w3.org/2000/svg"
                        alt="Marketing"
                ...
                <div className="cards">
                  <div className="course-row">
                    {props.propsdata.allData &&
                      ...
                      props.propsdata.allData.map((course) => {
                        return (
                          <div
                            className={
              ...
              <div className="mobiletab-ourprogram">
                <Accordion defaultActiveKey="1" className="dropdownourprogram">
                  <Accordion.Item eventKey="1" className="ourProgramaccordion">
                    <Accordion.Header>
                      <p className="navbar-drop-down-text">DATA SCIENCE</p>
                    </Accordion.Header>
                  ...
                  <Accordion.Item eventKey="3" className="ourProgramaccordion">
                    <Accordion.Header>
                      <p className="navbar-drop-down-text">SUPPLY CHAIN</p>
                    </Accordion.Header>
                    <Accordion.Body className="ourprogramaccans">
                      <Swiper
                        spaceBetween={26}
                  ...
                  <Accordion.Item eventKey="4" className="ourProgramaccordion">
                    <Accordion.Header>
                      <p className="navbar-drop-down-text">AI & ML</p>
                    </Accordion.Header>
                    <Accordion.Body className="ourprogramaccans">
                      <Swiper
                        spaceBetween={26}
        ...
        {/* <section className="seakadvisor">
          <div className="speackmaindiv">
            <div className="speakmain3" onClick={toggleModal}></div>
          </div>
        </section> */}
            ...
            <div className="joinimarticusdiv">
              ...
              <div className="join_imarticus_text">
                ...
                <div className="jointext_main">
                  ...
                  <div className="joininnertext">
                    <h2>Futuristic And Tailored Programs </h2>
                    <p>
        ...
        {/* Blog */}
        <Blogimarticus category="analytics" />
